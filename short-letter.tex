...
GDML participants in subsequent or parallel projects.
%
We will populate the library with relevant data, relying primarily on
our network of library partners.
%
We will develop features that facilitate computer-mediated and
computationally-driven improvements to the library's contents.
...
In addition we expect collaborate closely with the recently-convened
Global Digital Mathematics Library working group.
